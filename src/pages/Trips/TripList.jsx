    ...
    <div className="trips-root" style={{ maxWidth: "var(--max-w-xl)", margin: "0 auto", paddingBottom: "var(--sp-4xl)" }}>
      <div className="trips-header" style={{ marginBottom: "var(--sp-2xl)", display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: "var(--sp-lg)" }}>
        <div>
          ...
          <p style={{ color: "var(--cl-text)", opacity: 0.7, fontSize: "var(--fs-md)", margin: 0 }}>Manage your itineraries, budgets, and travel plans.</p>
        </div>
              ...
              return (
                <Link key={trip.id} to={ROUTES.tripDetail(trip.id)} className="card card-hover trip-list-card" style={{ position: "relative", overflow: "hidden", minHeight: "320px", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "var(--sp-2xl)", textDecoration: "none", border: "none", borderRadius: "var(--br-2xl)", boxShadow: "var(--shadow-md)" }}>
                  <div style={{ position: "absolute", inset: 0, zIndex: 0 }} aria-hidden>
                    ...
                    />
                    <div style={{ position: "absolute", inset: 0, background: "linear-gradient(to top, rgba(0,0,0,0.92) 0%, rgba(0,0,0,0.6) 50%, rgba(0,0,0,0.3) 100%)" }} />
                  </div>
